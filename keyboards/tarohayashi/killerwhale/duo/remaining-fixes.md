...
- had to rollback backspace change( I couldn't distinguish in regular console, which is erase, and which is "move to left window"
...
- Why the fuck data sync does not work? :((((((((((( https://docs.qmk.fm/features/split_keyboard#custom-data-sync
  The problem is literally ungooglable and doing debuging with oled screen only is honestly very inconvenient.
